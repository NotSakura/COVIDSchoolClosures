...
```
First, we take a look at the overall enrollment through out the districts. We can see that some values are in the negatives like the [0.364, 0.455] bin. This means that when the share of in-person school is at most 45.5% the enrollemnt rate is -0.0105% (Value found in the appendix)
